...
function searchIngredients(allDishes) {
    let userInput = prompt("Please enter a ingredient to search by: ");
    ...
    let foundIngredient = allDishes.filter(function (ingredient) {
        if (ingredient.ingredients.includes(userInput)) {
            return true;
        }
    })
